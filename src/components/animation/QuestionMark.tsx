...
export default function QuestionMark({ height, width }: QuestionMarkProps) {
  ...
  return (
    ...
    >
      <g>
        <circle className={styles.circle} cx="50" cy="50" r="50" fill="black" />
        <path
          ...
          strokeLinecap="round"
        />
        <circle className={styles.dot} ref={dotRef} cx="50.5" cy="78.5" r="3" stroke="white" strokeWidth="3" />
      </g>
    </svg>
  )
}