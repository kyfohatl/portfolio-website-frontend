...
export default function Error({ code }: ErrorProps) {
  ...
  return (
    <div className={styles.container}>
      ...
      <svg viewBox="0 0 478 291" fill="none">
        <rect x="2" y="2" width="474" height="287" fill="white" stroke="black" stroke-width="4" />
        <rect x="2" y="2" width="474" height="31" fill="#C4C4C4" stroke="black" stroke-width="4" />
        <rect x="443" y="2" width="33" height="31" fill="#FE834D" stroke="black" stroke-width="4" />
